...
const ArtistOfTheWeek = () => {
    return (
        <section className="flex flex-col  bg-yellow-50 ">
            ...
            <div className="drop-shadow-md flex flex-col sm:h-[700px] lg:flex-row rounded-[50px] md:rounded-[70px] overflow-hidden">
                <div className=" sm:relative flex flex-1 order-2  py-20 bg-none bg-yellow-300 sm:items-center sm:bg-artist lg:order-2 xl:bg-none lg:bg-yellow-300 bg-no-repeat bg-cover bg-center ">
                        ...
                        <div className="mt-12 flex flex-row items-center space-x-4">
                            ...
                            >
                                <button
                                    ...
                                    role="button"
                                >
                                    <span className="mr-1"> ▶️ </span> Watch
                                    Rema
                                </button>
                            </a>
                ...
                <div className="sm:z-10  opacity-75  bg-yellow-300  sm:opacity-100 order-1 sm:hidden xl:flex lg:order-1  ">
                    <img
                        src={RemaImage}
                        alt="Image of Rema "
