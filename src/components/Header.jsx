...
const Header = () => {
  return (
    <div className="flex flex-col drop-shadow-md sm:h-[700px] lg:flex-row rounded-b-[50px] bg-yellow-50 md:rounded-b-[70px]  overflow-hidden ">
      <div className="flex flex-1 order-2  py-20 bg-none bg-yellow-300 sm:items-center sm:bg-hero lg:order-1 xl:bg-none lg:bg-yellow-300 bg-no-repeat bg-cover bg-center ">
        <div className="w-[400px] mx-auto sm:mx-20 sm:w-[500px]">
          ...
          <div className="font-serif font-medium mt-10 text-xl  ">
            Sometimes, Friday hits and it almost doesn't feel real. Discover
            fans favorite afrobeat songs, updated weekly, to add color to your
            weekend.
          </div>
          <div className="mt-12 flex flex-row items-center space-x-4">
            <a href="https://en.wikipedia.org/wiki/Afrobeats" target="_blank">
              <button
            ...
            >
			  ...
			  "
                role="button"
              >
                <img src={YoutubeLogo} alt="Youtube logo" className="h-6 w-6" />
              </button>
            </a>
            <a
      ...
      <div className=" opacity-80 sm:opacity-100 order-1 sm:hidden xl:flex lg:order-2  ">
        <img
          src={GirlMusic}
